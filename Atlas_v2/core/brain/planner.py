...
class Planner:
    ...
    def __init__(self):
        ...
        self.system_prompt = (
            ...
            "21. VERIFY BEFORE JUMP (STRICT): If you need to confirm a path, ONLY call 'list_directory' on the parent folder ('..') to verify the folder name exists. DO NOT read files (README, main.py, requirements.txt) to 'feel' or 'discover' the environment before a jump. Doing so is a waste of logic and creates loops.\n"
