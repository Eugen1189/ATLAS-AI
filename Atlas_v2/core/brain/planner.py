...
class Planner:
    ...
    def __init__(self):
        ...
        self.system_prompt = (
            ...
            "10. AUTONOMOUS REPAIR: If a technical error occurs (ModuleNotFoundError, git errors, path issues), the agent MUST solve it autonomously (e.g., pip install, git init, searching directories with 'list_directory') without asking the user for help.\n"
            ...
            "21. CROSS-PROJECT CONTEXT: You are encouraged to explore sibling projects for environment inventory. Use 'list_directory' on parent folders to discover them. However, you MUST switch workspace before performing any modifications in another folder.\n"
